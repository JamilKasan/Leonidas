            ...
            <div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                <div class="lg:pr-4">
                    <div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                        <img class="absolute inset-0 h-full w-full object-cover saturate-8" src="{{ asset('storage/'. $recipe->image) }}" alt="">
                        <div class="absolute inset-0 bg-gray-900 mix-blend-multiply hidden"></div>
                        <div class="absolute left-1/2 top-1/2 -ml-16 -translate-x-1/2 -translate-y-1/2 transform-gpu blur-3xl hidden" aria-hidden="true">
                        ...
                        <figure class="relative isolate hidden">
...
{{--                            <img src="https://tailwindui.com/img/logos/workcation-logo-white.svg" alt="" class="h-12 w-auto">--}}
                            <blockquote class="mt-6 text-xl font-semibold leading-8 text-white bg-gray-600 bg-opacity-50">
                                <p>{{ $recipe->name }}</p>
                                <figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong class="font-semibold text-white">{{ 'Leonidas' }}</strong></figcaption>
                            </blockquote>
                ...
                <div>
                    <div class="text-base leading-7 text-gray-700 lg:max-w-lg">
                        <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">{{ $recipe->name }}</h1>
                        <div class="max-w-xl">
                            <p class="mt-3 text-xl text-b">Ingredients:</p>
                            <p class="mt-2">{!! $recipe->ingredients !!}</p>
                            <p class="mt-3 text-xl text-b">Instructions:</p>
